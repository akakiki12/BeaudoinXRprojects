...
using UnityEngine.XR.OpenXR.Input; //library for xr input
...
public class Bow : MonoBehaviour
{
    ...
    [Header("Haptics")]
    public HapticClipPlayer hapticClipPlayer; // reference to playing Haptic Studio Files
    ...
    private void PlayHapticFeedback()
    {
        ...
        {
            HapticSource hapticSource = m_PullingHand.GetComponent<HapticSource>(); //if hand is moving, preload haptic source
